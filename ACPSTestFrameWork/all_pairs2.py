...
import ACPSTestFrameWork.pairs_storage as pairs_storage
from ACPSTestFrameWork.combinatorics import xuniqueCombinations 
...
class all_pairs2:
    ...
    def __init__( self, options, filter_func = lambda x: True, n = 2 ):
        """
